...
/**
  ...
  *
  */
private[anntensor] trait Layer extends Serializable {
...
/**
  ...
  */
private[anntensor] class AffineLayer(val numIn: Int, val numOut: Int) extends Layer {
...
/**
  ...
  */
private[anntensor] object AffineLayerModel {
...
/**
  ...
  */
private[anntensor] trait ActivationFunction extends Serializable {
...
/**
  ...
  */
private[anntensor] class SigmoidFunction extends ActivationFunction {
...
/**
  ...
  */
private[anntensor] class FunctionalLayer (val activationFunction: ActivationFunction) extends Layer {
...
/**
  ...
  */
private[anntensor] class FunctionalLayerModel private[anntensor] (val layer: FunctionalLayer)
  extends LayerModel {
...
/**
  ...
  */
private[anntensor] trait Topology extends Serializable {
...
/**
  ...
  */
private[anntensor] trait TopologyModel extends Serializable {
...
/**
  ...
  * @param layers
  */
private[anntensor] class FeedForwardTopology private(val layers: Array[Layer]) extends Topology {
...
/**
  ...
  */
private[anntensor] object FeedForwardModel {
...
/**
  ...
  */
private[anntensor] class ANNGradient(topology: Topology, dataStacker: DataStacker) extends Gradient {
...
/**
  ...
  */
private[anntensor] class DataStacker(stackSize: Int, inputSize: Int, outputSize: Int)
...
/**
  * Simple updater
  */
private[anntensor] class ANNUpdater extends Updater {
